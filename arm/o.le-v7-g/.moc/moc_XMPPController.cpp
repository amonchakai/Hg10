/****************************************************************************
** Meta object code from reading C++ file 'XMPPController.hpp'
**
...
#include "../../../src/XMPPController.hpp"
#if !defined(Q_MOC_OUTPUT_REVISION)
#error "The header file 'XMPPController.hpp' doesn't include <QObject>."
...
static const char qt_meta_stringdata_XMPP[] = {
    "XMPP\0\0messageReceived(QXmppMessage)\0"
    "presenceReceived(QXmppPresence)\0"
};

void XMPP::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        Q_ASSERT(staticMetaObject.cast(_o));
        XMPP *_t = static_cast<XMPP *>(_o);
        switch (_id) {
        case 0: _t->messageReceived((*reinterpret_cast< const QXmppMessage(*)>(_a[1]))); break;
        case 1: _t->presenceReceived((*reinterpret_cast< const QXmppPresence(*)>(_a[1]))); break;
        default: ;
        }
    }
}

const QMetaObjectExtraData XMPP::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject XMPP::staticMetaObject = {
    { &QXmppClient::staticMetaObject, qt_meta_stringdata_XMPP,
      qt_meta_data_XMPP, &staticMetaObjectExtraData }
};
